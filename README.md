...
If you just my container (`jamesstevens/handshake-full-node`), to help with the
DNS it also has a DNS proxy that can split the DNS queries based on the `RD` bit.
